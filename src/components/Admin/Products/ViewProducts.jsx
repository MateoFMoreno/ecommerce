...
const ViewProducts = () => {
    ...
    const getProducts = () => {
        axios
            ...
            .catch(() => error("Error en la carga de las productos"));
    };
    ...
    const deleteProducts = () => {
        selectionModel.map((productID) =>
            axios
                ...
                .then(() => getProducts())
                .catch(() => error("Producto no eliminado"))
        );
    };
    ...
    const putProduct = () => {
        ...
        axios
            ...
            .then(() => getProducts())
            .catch(() => error("Error en la modificacion del producto"));
    };
        ...
        <div>
            ...
            <div>
                <Modal isOpen={modalIsOpen} onRequestClose={closeModal} style={customStyles} contentLabel="Add product">
                    ...
                    <AddProduct getProducts={getProducts} setIsOpen={setIsOpen}/>
                </Modal>
            </div>
            <Paper sx={{ m: 2 }}>
